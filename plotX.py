...
f5 = np.loadtxt('./tables/XQqg2Qq.dat').reshape(60, 8, 20, 10).T
f6 = np.loadtxt('./tables/XQgg2Qg.dat').reshape(60, 8, 20, 10).T
...
def myplot(folder, scale=1.0):
	...
	r3 = np.loadtxt('./%s/RQq2Qqg.dat'%folder).reshape(100, 8, 10).T/scale
	r4 = np.loadtxt('./%s/RQg2Qgg.dat'%folder).reshape(100, 8, 10).T/scale
